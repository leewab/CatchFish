		...
		if (t.showPSInspector){
			ETCGuiTools.BeginGroup();{
				...
				//	if (t.isNoOffsetThumb) t.isNoReturn = false;
                    ...
                    t.ThumbFreePosition = ETCGuiTools.Toggle("ThumbFreePosition", t.ThumbFreePosition, false);
                    t.ThumbFreeLimitX = EditorGUILayout.FloatField("ThumbFreeLimitX", t.ThumbFreeLimitX);
                    t.ThumbFreeLimitY = EditorGUILayout.FloatField("ThumbFreeLimitY", t.ThumbFreeLimitY);
                }
                ...
                t.backgroudRadius = EditorGUILayout.FloatField("Background radius", t.backgroudRadius);
                t.powerLine = (RectTransform)EditorGUILayout.ObjectField("Power line", t.powerLine, typeof(RectTransform), true);
