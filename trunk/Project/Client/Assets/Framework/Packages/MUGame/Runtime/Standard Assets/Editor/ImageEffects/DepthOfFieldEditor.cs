...
namespace UnityStandardAssets.ImageEffects {
    ...
    class DepthOfFieldEditor : Editor {
        ...
        SerializedProperty IsNearBlur;
        SerializedProperty IsFarBlur;
        SerializedProperty IsAutoComputeTarget;
        SerializedProperty IsAllowManageCameraDepthMode;
        //SerializedProperty IsUiDOF;
        ...
        void OnEnable() {
            ...
            IsFarBlur = serObj.FindProperty("IsFarBlur");
            IsNearBlur = serObj.FindProperty("IsNearBlur");
            IsAutoComputeTarget = serObj.FindProperty("IsAutoComputeTarget");
            IsAllowManageCameraDepthMode = serObj.FindProperty("IsAllowManageCameraDepthMode");
            //IsUiDOF = serObj.FindProperty("isUiDOF");
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(IsNearBlur, new GUIContent("Is Near Blur"));
            EditorGUILayout.PropertyField(IsFarBlur, new GUIContent("Is Far Blur"));
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.PropertyField(IsAutoComputeTarget, new GUIContent("Is Auto Compute Target"));
            EditorGUILayout.PropertyField(IsAllowManageCameraDepthMode, new GUIContent("Allow Manage CameraDepthMode"));
            //EditorGUILayout.PropertyField(IsUiDOF, new GUIContent("Is UI DOF"));
            EditorGUILayout.EndHorizontal();
