...
namespace MUGame
{
    ...
    public class ConfigUtil
    {
        ...
        {
            MUEngine.MURoot.GetLogger(LogType.CONFIG).LogError(text);
        }

        public static void LogWarning(string text)
        {
            MUEngine.MURoot.GetLogger(LogType.CONFIG).LogWarning(text);
        }

        public static void LoadRes(string name, Action<string, UnityEngine.Object> OnLoadFile)
        {
            MUEngine.MURoot.ResMgr.GetAsset(name, OnLoadFile);
        }
        ...
        {
            MUEngine.MURoot.ResMgr.RemoveAsset(name);
        }
        ...
        public static object GetArrayData(string _byteString, int type)
        {
            byte[] data = Convert.FromBase64String(_byteString);
            System.IO.MemoryStream ms = new System.IO.MemoryStream(data);
            System.IO.BinaryReader br = new System.IO.BinaryReader(ms);
            return ConfigUtil.GetIntermData(br, type);
