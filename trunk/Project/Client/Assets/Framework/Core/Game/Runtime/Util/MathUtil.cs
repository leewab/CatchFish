...
namespace Game
{
    public static class MathUtil
    {
        ...
        /// <returns>距离</returns>
        public static float DistanceTo(this Vector3 a, Vector3 to)
        {
        ...
        /// <param name="to">目标向量</param>
        /// <returns>距离</returns>
        public static float SqrDistanceTo(this Vector3 a, Vector3 to)
        {
        ...
        /// <returns>true 在camera里面 false  消失</returns>
        public static bool IsVisibleFrom(this Renderer renderer,Plane[] planes)
        {
            return GeometryUtility.TestPlanesAABB(planes, renderer.bounds);
        }
        public static string QuatToString(this Quaternion quat)
        {
            return string.Format("{0},{1},{2},{3}", quat.x, quat.y, quat.z, quat.w); ;
        }

        public static bool FloatEqual(this float f0, float f1)
        {
        ...
        public static Bounds DimensionToBound(Vector3 dim, BoundOriginType type)
        {
            ...
            switch(type)
            {
                ...
                break;
                default:
                //Logger.GetFile( MUEngine.LogFile.Global ).LogWarning("invalid bound origin type");
                break;
            }
