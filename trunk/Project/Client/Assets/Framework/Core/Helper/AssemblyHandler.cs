    ...
    public class AssemblyHandler
    {
        ...
        public static Type GetAssemblyType(string assembly, string typeName)
        {
            ...
            if (Application.platform == RuntimePlatform.Android || Application.isEditor)
                t = AssemblyHandler.GetAssembly(assembly).GetType(typeName);
            //其他平台使用默认程序集中的类型
            else
                t = AssemblyHandler.DefaultCSharpAssembly.GetType(typeName);
        ...
        {
            var t = AssemblyHandler.DefaultCSharpAssembly.GetType(typeName);
            return t;
        }
