...
namespace Game.Core
{
    public static class RegexHelper
    {
        ...
        /// <returns></returns>
        public static bool IsMatch(string inpStr, string patternStr)
        {
            return IsMatch(inpStr, patternStr, false, false);
        }

        /// <summary>
        /// 验证
        /// </summary>
        /// <param name="inpStr">验证string</param>
        /// <param name="patternStr">正则公式</param>
        /// <param name="isIgnoreCase">是否忽略大小写</param>
        /// <param name="isValidateWhiteSpace">是否验证空白字符</param>
        /// <returns></returns>
        public static bool IsMatch(string inpStr, string patternStr, bool isIgnoreCase, bool isValidateWhiteSpace)
        {
            if (!isValidateWhiteSpace && string.IsNullOrWhiteSpace(inpStr)) return false;
            Regex regex = null;
            if (isIgnoreCase)
            {
        ...
        /// <returns></returns>
        public static Match SelectChinese(string str)
        {
        ...
        /// <param name="regexOptions"></param>
        /// <returns></returns>
        public static bool IsOnlyChinese(string strContent)
        {
            string patternStr = @"^[\u4e00-\u9fa5]+$";
            return IsMatch(strContent, patternStr);
        }

        //是否只包含中文
        public static string onlyChinese = @"^[\u4e00-\u9fa5]+$";

        //是否包含中文
        public static string hasChinese = @"[\u4e00-\u9fa5]+$";
